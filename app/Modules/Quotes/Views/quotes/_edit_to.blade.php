...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="box-tools pull-right">
            <button class="btn btn-default btn-sm" id="btn-change-client" data-client-id="{{ $quote->client->id }}"><i
    ...
    <div class="box-body">
        ...
        <a href="{{ route('clients.show', [$quote->client->id]) }}"
            title="{{ trans('fi.view_client') }}"><strong>{{ $quote->client->unique_name }}</strong></a><br>
        @else
