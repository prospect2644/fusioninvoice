            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('client_name', $clients, $quote->client->name, ['id' => 'copy_client_name', 'class' => 'form-control client-lookup', 'autocomplete' => 'off', 'style'=>"width: 100%;"]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('document_number_scheme_id', $documentNumberSchemes, $quote->document_number_scheme_id, ['id' => 'copy_document_number_scheme_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
