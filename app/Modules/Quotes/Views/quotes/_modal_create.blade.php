            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('quote_date', date(config('fi.dateFormat')), ['id' => 'create_quote_date', 'class' => 'form-control', 'autocomplete' => 'off']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('document_number_scheme_id', $documentNumberSchemes, config('fi.quoteGroup'), ['id' => 'create_document_number_scheme_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
