...
@section('javascript')
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var settings = {
                placeholder: '{{ trans('fi.select_client_blank_for_all') }}',
                allowClear: true
            };
...
@section('content')
    ...
    <section class="content-header">
        ...
        <h1 class="pull-left">{{ trans('fi.client_invoice') }}</h1>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class=" form-group">
                                   {!! Form::select('client_name[]', $clients, '', ['id' => 'client_name', 'class' => 'form-control client-lookup',  'multiple' => 'multiple']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
