...
@section('content')
    ...
    <table class="alternate">
        ...
        <tr>
            ...
            <th style="width: 20%; text-align: left;">{{ trans('fi.category') }}</th>
            <th style="width: 20%; text-align: left;">{{ trans('fi.vendor') }}</th>
        ...
        @foreach ($results['expenses'] as $expense)
            <tr>
                ...
                <td class="amount">{{ $expense['tax'] }}</td>
        ...
        <tr>
            ...
            <td class="amount"><strong>{{ $results['tax_total'] }}</strong></td>
