    ...
    <div class="col-lg-12">
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    @can('contacts.update')
                    <a href="javascript:void(0)" class="update-default" data-default="to" data-contact-id="{{ $contact->id }}">{{ $contact->formatted_default_to }}</a>
                    @else
                ...
                <td>
                    @can('contacts.update')
                    <a href="javascript:void(0)" class="update-default" data-default="cc" data-contact-id="{{ $contact->id }}">{{ $contact->formatted_default_cc }}</a>
                    @else
                ...
                <td>
                    @can('contacts.update')
                    <a href="javascript:void(0)" class="update-default" data-default="bcc" data-contact-id="{{ $contact->id }}">{{ $contact->formatted_default_bcc }}</a>
                    @else
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @endcan
                                @can('contacts.delete')
                                <li><a href="javascript:void(0)" class="btn-delete-contact text-danger" data-contact-id={{ $contact->id }}><i class="fa fa-trash-o"></i> {{ trans('fi.delete') }}</a></li>
                                @endcan
                            </ul>
                        </div>
                    </td>
