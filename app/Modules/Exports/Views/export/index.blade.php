                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div id="tab-clients" class="tab-pane active">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_clients') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-quotes" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_quotes') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-quote-items" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_quote_items') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-invoices" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_invoices') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-invoice-items" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_invoice_items') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-payments" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_payments') }}</button>
                            {!! Form::close() !!}
                        </div>
                        <div id="tab-expenses" class="tab-pane">
                            ...
                            <button class="btn btn-sm btn-primary"><i class="fa fa-download"></i> {{ trans('fi.export_expenses') }}</button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
