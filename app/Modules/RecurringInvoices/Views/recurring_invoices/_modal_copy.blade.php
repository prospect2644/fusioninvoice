            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('client_name', $clients, $recurringInvoice->client->name, ['id' => 'copy_client_name', 'class' => 'form-control client-lookup', 'autocomplete' => 'off', 'style'=>"width: 100%;"]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('fi.document_number_schemes') }}</label>

                        <div class="col-sm-9">
                            {!! Form::select('document_number_scheme_id', $documentNumberSchemes, $recurringInvoice->document_number_scheme_id, ['id' => 'copy_document_number_scheme_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
