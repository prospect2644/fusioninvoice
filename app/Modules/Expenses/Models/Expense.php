...
class Expense extends Model
{
    ...
    protected $fillable = ['user_id', 'client_name', 'company_profile_id', 'expense_date', 'category_name', 'amount', 'tax', 'vendor_name', 'client_name', 'description', 'category_id', 'vendor_id'];
