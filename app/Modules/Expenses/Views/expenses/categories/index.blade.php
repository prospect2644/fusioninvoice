...
@section('content')
    ...
    <section class="content-header">
        <h1 class="pull-left">
            {{ trans('fi.expense_categories') }}
        </h1>

        <div class="pull-right">
            <a href="{{ route('expenses.categories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ trans('fi.new') }}</a>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{ route('expenses.categories.edit', [$expenseCategory->id]) }}"><i class="fa fa-edit"></i> {{ trans('fi.edit') }}</a></li>
                                                <li><a href="#"
                                                       data-action="{{ route('expenses.categories.delete',[$expenseCategory->id]) }}"
                                                       class="delete-expenses-categories text-danger"><i
