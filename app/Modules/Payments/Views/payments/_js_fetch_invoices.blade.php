    ...
    $(function () {
        ...
        $('#confirm-payment-invoices').on("click", function () {
            ...
            if (remaining_balance <= 0) {
                ...
                var header = remainZeroBalanceHeader;
            } else {
                ...
                var header = remainBalanceHeader;
            }
            ...
            if ($("input:checkbox:checked[id^='invoice_selection_']").length > 0) {
                ...
                alertify.confirm("{!! trans('fi.apply_pre_payment_warning') !!}", function () {
                    $("input:hidden[name='payment_intent']").val('pre_payment');
                    that.prop("disabled", true).html(that.data('loading-text'));
                    submitFetchInvoicesForm();
                }, function () {
                    alertify.alert().destroy();
                }).setHeader(confirmHeader).set({transition: 'zoom', defaultFocus: 'cancel', 'labels': {ok: 'Yes', cancel: 'No'}});
            }
