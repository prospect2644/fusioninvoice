<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::select('setting[quoteGroup]', $documentNumberSchemes, config('fi.quoteGroup'), ['class' => 'form-control']) !!}
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <button type="button" class="btn btn-info btn-sm" id="btn-recalculate-quotes"
