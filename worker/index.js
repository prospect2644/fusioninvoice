...
async function readWorkspace(db, workspaceId, identity) {
  const [clients, clientAddresses, invoices, invoiceItems, estimates, estimateItems, payments, items, subscriptions, expenses, tasks, tickets, ticketNotes, ticketTime, ticketEmailPreferences, ticketNoteDelivery, assets, accounts, contacts, fields, values] = await Promise.all([
